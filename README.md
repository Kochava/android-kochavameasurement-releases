## Android KochavaMeasurement
The Kochava Android SDK is a lightweight plugin which can be easily integrated into your Android project.

[![Download](https://img.shields.io/github/v/release/Kochava/android-kochavameasurement-releases?sort=semver)](https://github.com/Kochava/android-kochavameasurement-releases/releases)
